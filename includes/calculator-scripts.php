...
function sl_add_script(){
    ...
    wp_enqueue_style('calculator-main-style', plugins_url().'/roof-calculator/css/style.css?v.2.6');
    ...
    wp_enqueue_script('calculator-main-script', plugins_url().'/roof-calculator/js/main.js?v.2.6',array('jquery'));
}
